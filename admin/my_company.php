    ...
    <div class="section_body">
        <div class="profile_details">
            <div class="cover_image">
                ...
                <div id="profile_image" class="profile_">
                    <img id="main_profile_image" src="uploaded_images/<?php echo $user->get_logo(); ?>" alt="">
                    <form enctype="multipart/form-data">
                        ...
                        <input type="file" onchange="upload_company_logo();" id="file" name="file[]" multiple="multiple" class="hidden_input">
                    </form>
                </div>
            </div>

            <form action="parts/user_part/http/update_company.php" method="post">
