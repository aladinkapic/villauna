    ...
    <div class="section_body">
        <div class="categories_w">
            ...
            while($parent = $grand_q -> fetch()){
                ...
                if($parent['child'] != null and $parent['child'] == Input::get('id')){

                    if($parent['id'] == 32 || $parent['id'] == 33){
                        // All PC's
                        $link = 'items/pc.php';
                    }
                    ...
                    <div class="single_category single_category0">
                        ...
                        <a href="preview_items.php?path=Moj%20app&cat=Kategorije%20artikala&what=<?php echo $name; ?>&icon=fa-home&desc=Pregled%20glavnih%20kategorija%20artikala%20..&id=<?php echo $parent['id']; ?>&parent=<?php echo Input::get('id'); ?>">
