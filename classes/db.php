...
class Session{
    ...
    public static function setImageHash_u($hash){ return $_SESSION['imageHash'] = $hash; }
...
class DB{
    ...
    public  function __construct(){
        try{
            //$this->_pdo = new PDO('mysql:host=localhost;dbname=una','root','');
            $this->_pdo = new PDO('mysql:host=localhost;dbname=dvaba_vila','dvaba_vila','enciklopedija');
